...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // 🚀 终极解决方案：效仿项目原生的 Mock 策略，直接将导致 PWA 编译链崩溃的包重定向到空文件
      'image-in-browser': fileURLToPath(new URL('./src/_empty.ts', import.meta.url)),
      'fanger': fileURLToPath(new URL('./src/_empty.ts', import.meta.url)),
    },
  },
  define: {
